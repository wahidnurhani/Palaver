...
public class NewCommunicator {
    ...
    public Response<DataServerResponse<String>> authenticate(User user) throws IOException {
        Call<DataServerResponse<String>> call= service.validate(user);
        return call.execute();
    }

    public Response<DataServerResponse<String>> register(User user) throws IOException {
        Call<DataServerResponse<String>> call= service.register(user);
        return call.execute();
    }

    public Response<DataServerResponse<String>> fetchAllFriend(User user) throws IOException {
        Call<DataServerResponse<String>> call= service.getFriends(user);
        return call.execute();
    }

    public Response<DataServerResponse<String>> addFriend(User user, Friend friend) throws IOException {
