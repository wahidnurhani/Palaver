...
public class Retrofit {
    ...
    public Response<StackApiResponseList<String>> authenticate(User user) throws IOException {
        callListString = service.validate(user);
        return callListString.execute();
    }

    public Response<StackApiResponseList<String>> register(User user) throws IOException {
        callListString = service.register(user);
        return callListString.execute();
    }

    public Response<StackApiResponseList<String>> fetchAllFriend(User user) throws IOException {
        callListString = service.getFriends(user);
        return callListString.execute();
    }

    public Response<StackApiResponseList<String>> addFriend(User user, Friend friend) throws IOException {
    ...
    public Response<StackApiResponseList<Message>> getMessage(JSONBuilder.UserAndRecipient body) throws IOException {
        Call<StackApiResponseList<Message>> call = service.getMessage(body);
        return call.execute();
    }

    public Response<StackApiResponseDate> sendMessage(JSONBuilder.SendMessageBody body) throws IOException {
